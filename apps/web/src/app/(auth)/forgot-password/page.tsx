      ...
      <Card className="w-full max-w-md shadow-lg">
        {submittedEmail ? (<>
            <CardHeader className="space-y-3 text-center">
              ...
              <CardDescription>Si existe una cuenta para <strong>{submittedEmail}</strong>, we&apos;ve sent a password reset link.
              </CardDescription>
            </CardHeader>
            ...
            <CardContent>
              <div className="rounded-lg bg-muted/50 p-4 text-sm text-muted-foreground">
                ...
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>Espera unos minutos: los correos pueden demorarse</li>
