      ...
      <Card className="w-full max-w-md shadow-lg">
        {submittedEmail ? (<>
            <CardHeader className="space-y-3 text-center">
              ...
              <CardDescription>Si existe una cuenta no verificada para <strong>{submittedEmail}</strong>, we&apos;ve sent a new verification link.
              </CardDescription>
            </CardHeader>

            <CardContent>
              <div className="rounded-lg bg-muted/50 p-4 text-sm text-muted-foreground">
                <p className="font-medium text-foreground mb-1">¿No recibiste un correo?</p>
                <ul className="list-disc list-inside space-y-1">
                  <li>Revisa tu carpeta de spam</li>
                  <li>Tu cuenta puede que ya esté verificada</li>
                  <li>Espera unos minutos a que llegue</li>
                </ul>
              </div>
            </CardContent>
            ...
            <CardHeader className="space-y-2 text-center">
              ...
              <CardDescription>Introduce tu correo y te enviaremos un nuevo enlace de verificación.
              </CardDescription>
            </CardHeader>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit((values) => mutation.mutate(values))} className="space-y-4">
                  <FormField control={form.control} name="email" render={({ field }) => (<FormItem>
                        ...
                        <FormControl>
                          <Input type="email" placeholder="tu@ejemplo.com" autoComplete="email" autoFocus disabled={mutation.isPending} {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>
