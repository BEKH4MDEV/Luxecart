...
const NAV_LINKS = [
    ...
    { href: '/categories/home-living', label: "Inicio" },
];
export function Navbar() {
    ...
    return (<header className={`sticky top-0 z-50 w-full transition-all duration-200 ${isScrolled
      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-1">
            {NAV_LINKS.map((link) => (<Button key={link.href} variant="ghost" size="sm" asChild>
        ...
        <div className="flex items-center gap-1">
          ...
          <Button variant="ghost" size="icon" aria-label="Buscar productos" className="hidden sm:flex" asChild>
            <Link href="/products">
          ...
          {showAuthUI && (<Button variant="ghost" size="icon" aria-label="Lista de deseos" asChild className="hidden sm:flex">
              <Link href="/wishlist">
          ...
          <Button variant="ghost" size="icon" className="md:hidden ml-1" aria-label="Abrir menú">
